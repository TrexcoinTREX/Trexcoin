#############################################################################
# Makefile for building: trexcoin-qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: Thu Nov 23 11:04:29 2017
# Project:  Trexcoin-qt.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake RELEASE=1 -o Makefile Trexcoin-qt.pro
#############################################################################
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -Wl,-Bstatic -lminiupnpc /tmp/Trexcoin/src/leveldb/libleveldb.a /tmp/Trexcoin/src/leveldb/libmemenv.a -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -Wl,-Bdynamic -lrt -ldl -lpthread -lQtGui -lQtCore 
AR            = ar cqs
RANLIB        = 
...
Makefile: Trexcoin-qt.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
	...
	$(QMAKE) RELEASE=1 -o Makefile Trexcoin-qt.pro
...
/tmp/Trexcoin/src/leveldb/libleveldb.a: FORCE
	cd /tmp/Trexcoin/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/tmp/Trexcoin/build/build.h: FORCE
	cd /tmp/Trexcoin; /bin/sh share/genbuild.sh /tmp/Trexcoin/build/build.h
