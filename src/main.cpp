...
unsigned int nStakeMaxAge = 365 * 24 * 60 * 60; //  days as full weight
...
const string strMessageMagic = "Trexcoin Signed Message:\n";
...
bool IsStandardTx(const CTransaction& tx)
{
    ...
    // comtrexcoing signature hashes is O(ninputs*txsize). Limiting transactions
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Trexcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "1589364245";
        CTransaction txNew;
        txNew.nTime = 1589364245;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1589364245;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 3831438;
        ...
        assert(block.hashMerkleRoot == uint256("0x0260b695f980ef282a4a15f5b2616fd59e10789adf47654b5ae5a917d988f99c"));
